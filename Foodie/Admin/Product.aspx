                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                            placeholeder="Enter Product Name"></asp:TextBox>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control"
                                                            placeholeder="Enter Product Description" TextMode="MultiLine"></asp:TextBox>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control"
                                                            placeholeder="Enter Product Price"></asp:TextBox>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtQunatity" runat="server" CssClass="form-control"
                                                            placeholeder="Enter Product Qunatity"></asp:TextBox>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Qunatity must be in non negative"
                                                            ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div>                                                     
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT [ CategoryId] AS column1, [Name] FROM [Categories]"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                                        ...
                                                        <HeaderTemplate>
                                                            <table class="data-table-export table-hover nowrap">
                                                                <thead>
                                                                <tr>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td> <%# Eval("Price") %></td>
                                                                  <asp:Label ID="iblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label> </td>
                                                                ...
                                                                <td> 
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server"  CssClass="badge badge-primary"
                                                                        CommondArgument='<%# Eval("ProductId") %>' CommandName="edit">
                                                                        <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
